...
async function scrapeConstructors() {
  try {
    ...
    if (constructors.length < 10) {
      console.log(
        `Only found ${constructors.length} constructors, adding mock constructors to reach 10`
      );
  ...
  try {
    ...
    seasonResults.forEach(race => {
      ...
      if (race.results.length < 20) {
        console.log(
          `Race ${race.race} has only ${race.results.length} results, adding missing drivers`
        );
  ...
  const constructors = [
    {
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/red-bull-racing-logo.png.transform/2col/image.png',
    },
    {
      id: 'MCL',
      name: 'McLaren',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/mclaren-logo.png.transform/2col/image.png',
    },
    {
      id: 'FER',
      name: 'Ferrari',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/ferrari-logo.png.transform/2col/image.png',
    },
    {
      id: 'MER',
      name: 'Mercedes',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/mercedes-logo.png.transform/2col/image.png',
    },
    {
      id: 'AST',
      name: 'Aston Martin',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/aston-martin-logo.png.transform/2col/image.png',
    },
    {
      id: 'ALP',
      name: 'Alpine',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/alpine-logo.png.transform/2col/image.png',
    },
    {
      id: 'HAA',
      name: 'Haas F1 Team',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/haas-f1-team-logo.png.transform/2col/image.png',
    },
    {
      id: 'WIL',
      name: 'Williams',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/williams-logo.png.transform/2col/image.png',
    },
    {
      id: 'RB',
      name: 'Racing Bulls',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/rb-logo.png.transform/2col/image.png',
    },
    {
      id: 'SAU',
      name: 'Kick Sauber',
      ...
      logoUrl:
        'https://www.formula1.com/content/dam/fom-website/teams/2024/sauber-logo.png.transform/2col/image.png',
    },
  ];
